      ...
      <nav>
        <ul class="header-nav-ul">
          <li class="header-nav-item <?php if($currentPage === 'overview') { echo 'header-nav-item-active';} ?>">
            <a href="index.php?page=overview&view=day&day=<?php echo date("d-m-Y") ?>">
              <svg width="18px" height="18px" viewBox="0 0 18 18">
                <title>Overview link</title>
                <desc>Icon for overview.</desc>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g transform="translate(-742.000000, -42.000000)" <?php if($currentPage === 'overview') { echo 'fill="#2B2B2B"';} else { echo 'stroke="#2B2B2B"';} ?>  stroke-width="2">
          ...
          <li class="header-nav-item <?php if($currentPage === 'progress') { echo 'header-nav-item-active';} ?>">
            <a href="index.php?page=progress&category=statistics">
              <svg width="18px" height="18px" viewBox="0 0 18 18">
                <title>Progress link</title>
                <desc>Icon for progress.</desc>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g transform="translate(-911.000000, -42.000000)" <?php if($currentPage === 'progress') { echo 'fill="#2B2B2B"';} else { echo 'stroke="#2B2B2B"';} ?> stroke-width="2">
          ...
          <li class="header-nav-item <?php if($currentPage === 'profile') { echo 'header-nav-item-active';} ?>">
            <a href="index.php?page=profile&category=information">
              <svg width="20px" height="20px" viewBox="0 0 20 20">
                <title>Profile link</title>
                <desc>Icon for profile.</desc>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g transform="translate(-1083.000000, -41.000000)" <?php if($currentPage === 'profile') { echo 'fill="#2B2B2B"';} else { echo 'stroke="#2B2B2B"';} ?> stroke-width="2">
                    <g transform="translate(742.000000, 39.000000)">
